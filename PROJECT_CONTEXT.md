...
- `workspaces` (id, name, slug, custom_domain, custom_domain_status, custom_domain_verified_at, allowed_widget_domains[], inbound_token)
...
- `conversations` (id, workspace_id, contact_id, channel: chat | email, status: open | snoozed | resolved, assigned_agent_id, last_message_at, subject, ai_summary, ai_summary_updated_at, ai_summary_message_count)
...
8. Analytics dashboard (response times, resolution rates, agent performance) — the remaining stretch feature.
